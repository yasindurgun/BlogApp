    ...
    public partial class second : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagPostRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagPostRelations_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TagPostRelations_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagPostRelations_PostId",
                table: "TagPostRelations",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_TagPostRelations_TagId",
                table: "TagPostRelations",
                column: "TagId");
        }
